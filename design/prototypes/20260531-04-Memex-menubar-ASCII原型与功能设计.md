...
> ---
>
> **2026-06-07 注**：本文档描述的 menubar-only popup 形态已不再是当前架构。
> 当前形态：
> - **主窗口**为完整桌面应用（1100×720 sidebar + 5 个路由）
> - **托盘 popup** 收窄为 360×520 极简卡片（最近 5 条 session + 跳板按钮）
> - 详见：`20260607-01-Memex-popup替换为桌面应用-重构方案.md` 与 `20260607-02-Memex-popup转桌面-TODO.md`
