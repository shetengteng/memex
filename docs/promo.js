...
(function () {
  ...
  // v22: 语法精修 — Act 7 补回主语 "你", Acts 1/2/3/4/5 修主谓宾不通顺处.
  const NARRATION = {
    1: "这个软件太强了!你是不是经常碰到——\n切到下一个 AI 编辑器,上次聊到哪儿就找不到了？\nMemex,本地 AI 记忆中枢,就是来解决这个的。",
    2: "你想想啊——Claude Code、Cursor、Codex、OpenCode,\n四个工具同时开,对话散在四处,你每天都在反复说同一句话。",
    3: "更崩溃的是——上周在 Cursor 拍板的那套方案,\n今天翻了三个窗口、找了一小时,还是找不到。你已经第七次跟同一个模型讲同一件事了。",
    4: "所以我们做了 Memex。\n它把你和 AI 的每一句对话,直接写到本地 SQLite——\n不上云、不外传、谁也带不走。",
    5: "怎么用呢？很简单。\n你不用改任何习惯——打开 Cursor、敲下回车,后台 2 秒,这段对话就悄悄躺进本地数据库。",
