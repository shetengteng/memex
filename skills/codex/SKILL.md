---
name: memex
description: Local-first cross-LLM session memory hub — search, retrieve, and browse Codex / Cursor / Claude Code / OpenCode conversation history indexed locally with FTS5.
client: codex
---
