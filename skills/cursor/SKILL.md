---
name: memex
description: Local-first cross-LLM session memory hub — search, retrieve, and browse Cursor / Claude Code / Codex / OpenCode conversation history indexed locally with FTS5.
client: cursor
---
