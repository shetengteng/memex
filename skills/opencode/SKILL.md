---
name: memex
description: Local-first cross-LLM session memory hub — search, retrieve, and browse OpenCode / Cursor / Codex / Claude Code conversation history indexed locally with FTS5.
client: opencode
---
